    ...
    checkIfUserPasswordIsCorrect({ body }, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                 ...
                 */
                const compare = yield auth_helper_1.default.comparePassword(password, existingUser.password);
                if (compare)
                    return next();
                return next(new http_exception_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, user_message_1.MESSAGE_INVALID_CREDENTIALS));
            }
            catch (e) {
                return next(e);
            }
